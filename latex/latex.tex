...
\begin{frame}
  ...
  \item Publication
    \begin{itemize}
    \item \textbf{\href{run:./doc/Publi.pdf}{Recherche scientifique}}
    \item \textbf{Thèse}
    \end{itemize}  
  \item \href{run:./doc/cv1.pdf}{CV classique} / \href{run:./doc/cv2.pdf}{CV moderne}
  \item \href{run:./doc/livre.pdf}{Livre}
  \end{itemize}
\end{frame}
